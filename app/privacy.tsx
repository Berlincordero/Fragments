// app/privacy.tsx  ← POLÍTICA DE PRIVACIDAD (estilo FRAGMENTS + degradado + reflejo)
...
// Degradado de fondo (matching login/register)
const BG_GRADIENT = ["#0B131A", "#121C25", "#18242F"] as const;

// Degradado turquesa (matching login/register)
const TURQ_GRADIENT = ["#00F7B0", "#fff8fbff", "#fa0089ff"] as const;
    ...
    <LinearGradient colors={BG_GRADIENT} style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <MaskedView
          ...
          maskElement={<Text style={[styles.titleText, { fontSize: TITLE_SIZE }]}>Política de privacidad</Text>}
        >
          <LinearGradient
            colors={TURQ_GRADIENT}
            start={{ x: 0, y: 0 }}
